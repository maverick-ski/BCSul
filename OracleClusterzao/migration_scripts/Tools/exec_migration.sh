...
echo "**************************************************************************************"
TimeStamp
impdp \"sys\/$ORA_STRING@tools as sysdba\" status=600 schemas=\('CI','ODI','AVERB','EXCEL','ZABBIX','SCC3533','ODI_TMP','SCCTOOLS','FIX_FECH','NETBACKUP','SUPORTERJ','AVERB_JOBS','SQLGERENCIAL','SQL_GERENCIAL','SCCTOOLS_JOBS','SUPORTERJ_JOBS','CONCILIACAO_DB'\) EXCLUDE=CONSTRAINT,REF_CONSTRAINT,DB_LINK,INDEX,TRIGGER TRANSFORM=DISABLE_ARCHIVE_LOGGING:Y directory=PUMP_DIR dumpfile=METADATA_RACTOOLS_01.DMP logfile=PUMP_DIR:metadata_imp_RACTOOLS.log METRICS=y
echo " "
...
echo "***************************"
TimeStamp
impdp \"sys\/$ORA_STRING@tools as sysdba\" parallel=6 status=600 schemas=\('CI','ODI','AVERB','EXCEL','ZABBIX','SCC3533','ODI_TMP','SCCTOOLS','FIX_FECH','NETBACKUP','SUPORTERJ','AVERB_JOBS','SQLGERENCIAL','SQL_GERENCIAL','SCCTOOLS_JOBS','SUPORTERJ_JOBS','CONCILIACAO_DB'\) EXCLUDE=CONSTRAINT,REF_CONSTRAINT,DB_LINK,INDEX,VIEW,PROCEDURE,FUNCTION,TRIGGER,PACKAGE,PACKAGE_BODY TRANSFORM=DISABLE_ARCHIVE_LOGGING:Y directory=PUMP_DIR dumpfile=METADATA_RACTOOLS_01.DMP logfile=PUMP_DIR:metadata_imp_RACTOOLS.log METRICS=y
echo " "
...
echo "**************************"
TimeStamp
impdp \"sys\/$ORA_STRING@tools as sysdba\" parallel=6 status=600 schemas=\('CI','ODI','AVERB','EXCEL','ZABBIX','SCC3533','ODI_TMP','SCCTOOLS','FIX_FECH','NETBACKUP','SUPORTERJ','AVERB_JOBS','SQLGERENCIAL','SQL_GERENCIAL','SCCTOOLS_JOBS','SUPORTERJ_JOBS','CONCILIACAO_DB'\) INCLUDE=CONSTRAINT,REF_CONSTRAINT,INDEX TRANSFORM=DISABLE_ARCHIVE_LOGGING:Y directory=PUMP_DIR dumpfile=METADATA_RACTOOLS_01.DMP logfile=PUMP_DIR:idx_imp_metadata_RACTOOLS.log METRICS=y
#impdp \"sys\/$ORA_STRING@tools as sysdba\" parallel=8 status=600 schemas=\('CI','ODI','AVERB','EXCEL','ZABBIX','SCC3533','ODI_TMP','SCCTOOLS','FIX_FECH','NETBACKUP','SUPORTERJ','AVERB_JOBS','SQLGERENCIAL','SQL_GERENCIAL','SCCTOOLS_JOBS','SUPORTERJ_JOBS','CONCILIACAO_DB'\) REMAP_TABLESPACE=TEMP1:TEMP,TEMP2:TEMP INCLUDE=INDEX TRANSFORM=DISABLE_ARCHIVE_LOGGING:Y directory=PUMP_DIR dumpfile=METADATA_RACTOOLS_01.DMP logfile=PUMP_DIR:idx_imp_metadata_RACFINL_MATERA.log METRICS=y
echo " "
...
echo "***************************"
TimeStamp
impdp \"sys\/$ORA_STRING@tools as sysdba\" status=600 schemas=\('CI','ODI','AVERB','EXCEL','ZABBIX','SCC3533','ODI_TMP','SCCTOOLS','FIX_FECH','NETBACKUP','SUPORTERJ','AVERB_JOBS','SQLGERENCIAL','SQL_GERENCIAL','SCCTOOLS_JOBS','SUPORTERJ_JOBS','CONCILIACAO_DB'\) INCLUDE=TRIGGER CLUSTER=NO directory=PUMP_DIR dumpfile=METADATA_RACTOOLS_01.DMP logfile=PUMP_DIR:triggers_imp_metadata_RACTOOLS.log METRICS=y
echo " "
...
echo "*************************"
TimeStamp
impdp \"sys\/$ORA_STRING@tools as sysdba\" status=600 schemas=\('CI','ODI','AVERB','EXCEL','ZABBIX','SCC3533','ODI_TMP','SCCTOOLS','FIX_FECH','NETBACKUP','SUPORTERJ','AVERB_JOBS','SQLGERENCIAL','SQL_GERENCIAL','SCCTOOLS_JOBS','SUPORTERJ_JOBS','CONCILIACAO_DB'\) INCLUDE=GRANT,SYNONYM CLUSTER=NO directory=PUMP_DIR dumpfile=METADATA_RACTOOLS_01.DMP logfile=PUMP_DIR:gs_imp_metadata_RACTOOLS.log METRICS=y
echo " "
